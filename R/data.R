...
#' \insertCite{Hodgkins.2018;textual}{ir} derived the data set from \insertCite{LaCruz.2015;textual}{ir} \url{https://www.liebertpub.com/doi/full/10.1089/ees.2014.0402}.
#' @references
#'   \insertAllCited{}
"ir_sample_data"
