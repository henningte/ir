...
#' .spc file or several of such files. \code{ir_import_spc} is a wrapper
#' function to \code{\link[hyperSpec:read.spc]{read.spc}}.
#'
...
#' extracted by \code{\link[hyperSpec:read.spc]{read.spc}}. Metadata variables
#' are:
#' \describe{
