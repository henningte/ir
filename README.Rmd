...
1. [`r rmarkdown::yaml_front_matter("vignettes/ir-introduction.Rmd")$title`](vignettes/ir-introduction.Rmd)
2. [`r rmarkdown::yaml_front_matter("vignettes/ir-class.Rmd")$title`](vignettes/ir-class.Rmd)
