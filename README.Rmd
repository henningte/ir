...
<!-- badges: start -->
[![Lifecycle: maturing](https://img.shields.io/badge/lifecycle-maturing-blue.svg)](https://www.tidyverse.org/lifecycle/#maturing) [![DOI](https://zenodo.org/badge/234117897.svg)](https://zenodo.org/badge/latestdoi/234117897)
<!-- badges: end -->
...
> Henning Teickner (`r format(Sys.Date(), "%Y")`). _ir: A Simple Package to Handle and Preprocess Infrared Spectra'_. DOI: 10.5281/zenodo.5747170. Accessed `r format(Sys.Date(), "%d %b %Y")`. Online at <https://github.com/henningte/ir>.
