...
With ir, it is very easy to build complex reprocessing workflows by "piping" (using [marittr's](https://cran.r-project.org/web/packages/magrittr/index.html) pipe (`%>%`) operator) together different preprocessing steps:
